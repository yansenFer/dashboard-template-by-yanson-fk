      ...
      <div className="flex items-center gap-3">
        <Icon
          className={cn(
            ...
            active ? "text-orange-500" : isDark ? "text-slate-500 group-hover:text-white" : "group-hover:text-foreground",
          )}
        />
        <span className={cn(
    ...
    <Layout isFullscreen>
      <div className={cn(
        ...
        <div className={cn(
          ...
          isDark ? "bg-slate-950/80 border-slate-800" : "bg-slate-50/30 border-slate-200"
        )}>
          <div className="p-6">
          ...
          <div className={cn(
            ...
            <div className={cn(
              ...
              isDark ? "bg-slate-900/50 border-slate-800" : "bg-orange-500/5 border-orange-500/10"
            )}>
            ...
            <div className="mt-4 flex items-center justify-between px-2">
              <Settings className={cn(
                ...
                isDark ? "text-slate-500 hover:text-white" : "text-muted-foreground hover:text-foreground"
              )} />
              <Info className={cn(
                "w-4 h-4 cursor-pointer transition-colors",
                isDark ? "text-slate-500 hover:text-white" : "text-muted-foreground hover:text-foreground"
          ...
          <header className={cn(
            ...
            <div className="flex items-center gap-4 flex-1">
              <div className="flex items-center gap-1.5 text-sm font-medium">
                ...
                <span className={isDark ? "text-slate-700" : "text-muted-foreground/40"}>/</span>
                <div className="flex items-center gap-1 cursor-pointer group">
                  <span className={isDark ? "text-slate-200" : ""}>My Space</span>
                  <ChevronDown className={cn(
                    "w-3.5 h-3.5 transition-colors",
                    isDark ? "text-slate-500 group-hover:text-white" : "text-muted-foreground group-hover:text-foreground"
                  )} />
                </div>
              </div>
              ...
              <div className="relative max-w-md w-full ml-4 group">
                <Search className={cn(
                  ...
                  isDark ? "text-slate-500 group-focus-within:text-orange-500" : "text-muted-foreground group-focus-within:text-orange-500"
                )} />
                <Input
                  placeholder="Search files and folders..."
                  className={cn(
                    "pl-10 h-10 transition-all rounded-xl border-transparent focus:ring-orange-500/20",
                    isDark ? "bg-slate-900 text-slate-200 focus:bg-slate-950" : "bg-muted/30 focus:bg-background"
                  )}
                />
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className={cn(
                  "rounded-lg",
                  isDark ? "text-slate-400 hover:text-white hover:bg-slate-900" : "text-muted-foreground"
                )}
              >
              ...
              <div className={cn("w-px h-6 mx-1", isDark ? "bg-slate-800" : "bg-border")} />
              <div className={cn(
                ...
                <Button
                  ...
                  className={cn(
                    ...
                    isDark ? "text-slate-500 hover:text-slate-300" : "text-muted-foreground"
                  )}
                >
              ...
              <Button variant="outline" size="icon" className={cn(
                ...
                isDark ? "bg-slate-950 border-slate-800 text-slate-400 hover:bg-slate-900 hover:text-white" : ""
              )}>
            ...
            <div className="flex items-center gap-8 h-12">
              <button
                ...
                className={cn(
                  ...
                  selectedTab === "cloud"
                    ? "text-orange-500"
                    : isDark ? "text-slate-500 hover:text-slate-200" : "text-muted-foreground hover:text-foreground",
                )}
              >
                Cloud Documents
                {selectedTab === "cloud" && (
          ...
          <div className="flex-1 overflow-auto">
            <Table>
              <TableHeader className={cn(
                ...
                isDark ? "bg-slate-950/95 border-slate-800" : "bg-background/95"
              )}>
                <TableRow className="hover:bg-transparent border-none">
                  <TableHead className="w-12 text-center">
                    <Checkbox className={cn(
                      ...
                      isDark ? "border-slate-700" : "border-muted-foreground/30"
                    )} />
                  </TableHead>
                ...
                {mockFiles.map((file) => (
                  <TableRow
                    ...
                    className={cn(
                      ...
                      isDark ? "border-slate-800 hover:bg-orange-500/[0.05]" : "hover:bg-orange-500/[0.02]"
                    )}
                  >
                    ...
                    <TableCell>
                      <div className="flex items-center gap-4 py-1">
                        <div className="relative group/star">
                          ...
                          <div
                            className={cn(
                              ...
                              isDark ? "bg-slate-900 border-slate-700" : "bg-background border shadow-sm",
                              file.starred
                                ? "opacity-100"
                        ...
                        <div className="flex flex-col min-w-0">
                          <span className={cn(
                            "font-semibold text-[13.5px] truncate max-w-[200px] transition-colors",
                    ...
                    <TableCell>
                      <div className="flex -space-x-2">
                        ...
                        {file.sharing.length === 0 && (
                          <span className={isDark ? "text-slate-800" : "text-muted-foreground/40"}>—</span>
                        )}
                      </div>
                    </TableCell>
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          ...
                          >
                            <MoreHorizontal className={cn(
                              "w-4 h-4 transition-colors",
                              isDark ? "text-slate-500 group-hover:text-slate-300" : "text-muted-foreground"
                            )} />
                          </Button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent
                        ...
                        >
                          <DropdownMenuItem className={cn(
                            ...
                            isDark ? "focus:bg-slate-900 focus:text-white" : ""
                          )}>
                          ...
                          <div className={cn("h-px my-1", isDark ? "bg-slate-800" : "bg-border")} />
