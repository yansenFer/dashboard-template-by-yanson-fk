...
const FAQ_DATA: FAQItem[] = [
  {
    ...
    answer:
      "You can get started by installing the dependencies using `npm install` and then running the development server with `npm run dev`. Our template comes with a comprehensive setup guide in the README file to help you customize everything quickly.",
  },
  {
    id: "2",
    category: "Technical",
    ...
    answer:
      "Yes! While this version is built for React Router / Vite, the components are modular and written in Tailwind CSS, making it easy to port to Next.js or any other React-based framework with minimal effort.",
  },
  {
    id: "3",
    category: "General",
    ...
    answer:
      "Absolutely. Every page and component in this template has been meticulously designed and tested to look great on mobile, tablet, and desktop devices. We use Tailwind CSS's responsive utilities to ensure a perfect fit.",
  },
  {
    id: "4",
    category: "Billing",
    ...
    answer:
      "The template comes with a standard commercial license which allows you to use it for personal or business projects. For multi-client use or resale as part of a larger product, please check our extended license options.",
  },
  {
    id: "5",
    category: "Technical",
    ...
    answer:
      "All theme colors are handled via CSS variables in the `app.css` file. You can easily change the primary, secondary, and accent colors to match your brand by updating those variables.",
  },
  {
    id: "6",
    category: "Privacy",
    ...
    answer:
      "The template is a pure frontend layout and does not store any personal data. You are in full control of where and how you connect your backend and handle user data security.",
  },
  {
    id: "7",
    category: "Billing",
    ...
    answer:
      "No, this is a one-time purchase. Once you buy the template, you get lifetime access to current and future updates for that version without any additional fees.",
  },
];
...
export default function Faq() {
  ...
  return (
    <Layout>
      <div className="flex flex-col gap-10 pb-20 mx-auto w-full">
        {/* Hero Section */}
        <div className="flex flex-col items-center text-center gap-4 mt-8">
          ...
          <p className={cn("text-base max-w-xl", textMuted)}>
            Find answers to common questions about our template. Can't find what
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={cn(
                  ...
                  isDark
                    ? "bg-slate-900/50 border-slate-800 focus:border-orange-500/50"
                    : "bg-white border-slate-100 focus:border-orange-500/50",
                )}
              />
            </div>
          </div>
          ...
          <AnimatePresence mode="popLayout">
            {filteredFaqs.length > 0 ? (
                  ...
                  >
                    <Card
                      ...
                      className={cn(
                        ...
                        isOpen
                          ? "shadow-xl ring-1 ring-orange-500/20"
                          : "hover:scale-[1.01]",
                      )}
                    >
                      <div className="p-6 flex items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            <h3
                              className={cn("text-lg font-bold", textPrimary)}
                            >
                              {faq.question}
                            </h3>
                            {!isOpen && (
                              <p
                                className={cn(
                                  "text-xs font-semibold mt-1 uppercase tracking-widest",
                                  textMuted,
                                )}
                              >
                                {faq.category}
                        ...
                        <div
                          className={cn(
                            ...
                            isOpen
                              ? "bg-orange-500 text-white rotate-180 shadow-lg"
                              : isDark
                        ...
                        {isOpen && (
                          ...
                          >
                            <div className={cn("px-8 pb-8 pt-2", textMuted)}>
                              <div
                                className={cn(
                                  "border-l-2 border-orange-500/30 pl-6 py-2 leading-relaxed text-base italic whitespace-pre-line",
                                )}
                              >
                                {faq.answer}
                              </div>
                              <div className="mt-6 flex items-center gap-3">
                                ...
                                <div className="flex gap-2">
                                  <Button
                                    variant="outline"
                                    size="sm"
                                    className="h-8 rounded-lg px-4 hover:bg-orange-500 hover:text-white transition-all"
                                  >
                                    Yes
                                  </Button>
                                  <Button
              ...
              >
                ...
                <h3 className={cn("text-xl font-bold", textPrimary)}>
                  No results found
                </h3>
                <p className={cn("text-sm max-w-xs text-center", textMuted)}>
                  We couldn't find any questions matching your search for "
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex flex-col gap-3 text-center md:text-left">
              ...
              <p className={cn("text-sm max-w-sm", textMuted)}>
                Our dedicated support team is here to help you solve any issues
